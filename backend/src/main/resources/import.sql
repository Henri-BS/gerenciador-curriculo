INSERT INTO tb_cv (name, description, image, phone, email, location) VALUES ('Nicolas Jones', 'Possuo mais de 15 anos de expertise na criação e execução de estratégias inovadoras para impulsionar marcas. Com formação em marketing e pós-graduação em marketing digital, destaca-se por sua habilidade em analisar dados e criar campanhas integradas que transcendem as expectativas do mercado. O comprometimento com a excelência e a paixão por inovação são características que leva para as equipes que lidera.', 'https://cdn4.iconfinder.com/data/icons/diversity-v2-0-volume-05/64/fitness-trainer-asian-male-512.png', '(91)91634-5358', 'nicolas@gmail.com', 'Acará - PA');
